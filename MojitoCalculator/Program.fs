...
let superJuiceRecipeTextFormatter (tw: TextWriter) (sj: SuperJuiceRecipe) =
    tw.WriteLine("{0:0} grams of Lime Peel", sj.LimePeel)
    tw.WriteLine("{0:0} grams citric acid", sj.CitricAcid)
    tw.WriteLine("{0:0} grams malic acid", sj.MalicAcid)
    tw.WriteLine("{0:0} grams water", sj.Water)
...
let mojitoRecipeTextFormatter (tw: TextWriter) (m: MojitoRecipe) = 
    ...
    superJuiceRecipeTextFormatter tw m.SuperJuice
