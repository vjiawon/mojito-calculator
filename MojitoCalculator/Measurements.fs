...
// super juice ratios
let limePeelPerLiterSuperJuice = 100.0<gram/liter>
let gramsCitricAcidPerLiterSuperJuice = 44.0<gram/liter>
let gramsMalicAcidPerLiterSuperJuice = 7.0<gram/liter>
